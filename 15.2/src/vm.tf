#/home/dmlorren/vm.tf                                                                                                                                                     1474/2773               53%
...
#!/bin/bash
cd /var/www/html
echo '<html><head><title>unsplash</title></head> <body><h1>Best wallpepper</h1><img src="http://${yandex_storage_bucket.dmlorren.bucket_domain_name}/osen.jpg"/></body></html>' > index.html
EOF
    }
  }
